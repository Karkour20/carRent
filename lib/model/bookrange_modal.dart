...
class Bookeddate {
  ...
  factory Bookeddate.fromFirebase(Map<String, dynamic> json) => Bookeddate(
    pickupDate: convertTimestampToDateTime(json["pickup_date"]),
    returnDate: convertTimestampToDateTime(json["return_date"]),
  );
