...
class _StripePaymentWebState extends State<StripePaymentWeb> {
  ...
  String get initialUrl =>
      '${Config.pGateway}stripe/index.php?name=${payCard!.name}&email=${payCard!.email}&cardno=${payCard!.number}&cvc=${payCard!.cvv}&amt=${payCard!.amount}&mm=${payCard!.month}&yyyy=${payCard!.year}';
