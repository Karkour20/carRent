...
class _AvailablecarScreenState extends State<AvailablecarScreen> {
  ...
  Future viewFeature(uid, lats, longs, city) async {
    ...
    try{
      ...
      List<FeatureCar> featureCarList =await featuredcars();
        setState(() {
          // viewFeatureModal=ViewFeatureModal(responseCode: 'aa', result: 'bb', responseMsg: 'cc', isBlock: 'dd', tax: 'ee', currency: 'u', featureCar:featureCar );
         viewFeatureModal = ViewFeatureModal(responseCode: "200", result: "result", responseMsg: "responseMsg", isBlock: "f", tax: "20", currency: "JOD", featureCar: featureCarList);
          isLoading = false;
                              ...
                              children: [
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    image: DecorationImage(image: NetworkImage(Config.imgUrl+viewFeatureModal!.featureCar[index].carImg.first),fit: BoxFit.cover),
                                  ),
                                ),
                                SizedBox(width: 10),
                                Expanded(
