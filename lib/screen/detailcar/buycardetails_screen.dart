...
class BuyCarDetailsScreen extends StatefulWidget {
  ...
  const BuyCarDetailsScreen({super.key, required this.CarId, required this.price, required this.withDriver, required this.ptype, required this.minHrs, required this.featureCar});
...
class _BuyCarDetailsScreenState extends State<BuyCarDetailsScreen> {
  ...
  void initState() {
    bookRangeModal = BookRangeModal(
        bookeddate: widget.featureCar.bookeddate??[],
    ...
    try {
      ...
      // if (response.statusCode == 200) {
        ...
        setState(() {
          ...
          //     bookeddate: [
          //     Bookeddate(
          //     pickupDate: DateTime(2024, 8, 1, 9, 0), // Example date and time
          // returnDate: DateTime(2024, 8, 5, 14, 30), // Example date and time
          // ),     Bookeddate(
          //         pickupDate: DateTime(2024, 7, 24, 10, 30), // Example date and time
          //         returnDate: DateTime(2024, 7, 30, 16, 45), // Example date and time
          //       )         ]
          //     , responseCode: "responseCode", result: "result", responseMsg: "responseMsg");
          isLoading = false;
                    ...
                    Navigator.push(
                        ...
                        MaterialPageRoute(
                            builder: (context) => ReviewSummery(
                              startDateTime: sdate!, endDateTime: edate!,
                                ...
                                eTime:
                                '${date2.hour}:${date2.minute}:${date2.second}', featureCar: widget.featureCar,)));
                  }
