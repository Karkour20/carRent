...
class CarDetailsScreen extends StatefulWidget {
  ...
  const CarDetailsScreen( {super.key, required this.id, required this.currency,  this.carInfo});
...
class _CarDetailsScreenState extends State<CarDetailsScreen> {
    ...
    try{
      ...
      if(response.statusCode == 200){
        setState(() {
          ...
          loading = false;
          _onAddMarkerButtonPressed(double.parse(widget.carInfo!.carinfo.pickLat), double.parse(widget.carInfo!.carinfo.pickLng));
          getLocation();
          Map<String, dynamic> carData = {
            "id" : widget.carInfo!.carinfo.id,
            "type_id" : widget.carInfo!.carinfo.typeId,
            "city_id" : widget.carInfo!.carinfo.cityId,
            "brand_id" : widget.carInfo!.carinfo.brandId,
            "car_img" : Config.imgUrl+widget.carInfo!.carinfo.carImg[0],
            "car_title" : widget.carInfo!.carinfo.carTitle,
            "car_rating" : widget.carInfo!.carinfo.carRating,
            "car_type_title" : widget.carInfo!.carinfo.carTypeTitle,
            "car_rent_price" : widget.carInfo!.carinfo.carRentPrice,
            "price_type" : widget.carInfo!.carinfo.priceType,
            "car_rent_price_driver" : widget.carInfo!.carinfo.carRentPriceDriver,
            "car_brand_title" : widget.carInfo!.carinfo.carBrandTitle,
            "IS_FAVOURITE" : widget.carInfo!.carinfo.isFavorite,
          };
          String encode = jsonEncode(carData);
          preferences.setString('carinfo', encode);
          for(int i=0; i<widget.carInfo!.galleryImages.length; i++){
            listOfUrls.add(Config.imgUrl+widget.carInfo!.galleryImages[i]);
          }
        });
  ...
  Future rateList(carId) async {
    // todo rateList CarDetailsScreen
    Map body = {
      "car_id" : carId,
    };
    try{
...
//var id = jsonDecode(sharedPreferences.getString('UserLogin')!);
  ...
  Future getLocation() async {
    ...
    distance = Geolocator.distanceBetween(position.latitude, position.longitude, double.parse(widget.carInfo!.carinfo.pickLat), double.parse(widget.carInfo!.carinfo.pickLng));
  ...
  Widget build(BuildContext context) {
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        bottomNavigationBar: loading ? SizedBox() : Container(
          height: 70,
          ...
          child: Row(
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  RichText(text: TextSpan(
                    children: [
                      TextSpan(text: '${'\$'}${widget.carInfo!.carinfo.carRentPrice} ', style: TextStyle(color: onbordingBlue, fontFamily: FontFamily.europaBold, fontSize: 20)),
                      TextSpan(text: '/${widget.carInfo!.carinfo.priceType == '1' ? "hr".tr : "days".tr}', style: TextStyle(color: Colors.grey, fontFamily: FontFamily.europaWoff, fontSize: 15)),
                    ],
                  )),
                ],
              ),
              ...
              GestButton(
                ...
                onclick: () {
                  Get.to(BuyCarDetailsScreen(CarId: widget.carInfo!.carinfo.id, price: '${widget.currency} ${widget.carInfo!.carinfo.carRentPrice}', withDriver: '${widget.currency}${widget.carInfo!.carinfo.carRentPriceDriver}', ptype: widget.carInfo!.carinfo.priceType == '1' ? "hr" : "days", minHrs: widget.carInfo!.carinfo.minHrs, featureCar: widget.carInfo!.carinfo,));
                },
              ),
            ],
          ),
        ),
        body: loading ? loader() : CollapsingAppBarPage(
          Id: widget.id,
          favorite: widget.carInfo!.carinfo.isFavorite.toString(),
          carTitle: widget.carInfo!.carinfo.carTitle,
          carInfo: widget.carInfo,
          bodyCreator: (context) {
            return Column(
              children: [
                ListTile(
                  title: Text(widget.carInfo!.carinfo.carTitle, style: TextStyle(fontFamily: FontFamily.europaBold, fontSize: 18, color: notifire.getwhiteblackcolor)),
                  trailing: RichText(text: TextSpan(
                    children: [
                      TextSpan(text: '${widget.currency}${widget.carInfo!.carinfo.carRentPrice} ', style: TextStyle(color: onbordingBlue, fontFamily: FontFamily.europaBold, fontSize: 20)),
                      TextSpan(text: '/${widget.carInfo!.carinfo.priceType == '1' ? "hr".tr : "days".tr}', style: TextStyle(color: Colors.grey, fontFamily: FontFamily.europaWoff, fontSize: 15)),
                    ],
                  )),
                ),
                SingleChildScrollView(
                  ...
                  child: Row(
                    children: [
                      carType(image: Appcontent.engine, title: 'Engine displacement'.tr, subtitle: widget.carInfo!.carinfo.engineHp),
                      carType(image: Appcontent.gearbox, title: 'Transmission type'.tr, subtitle: widget.carInfo!.carinfo.carGear == '1' ? 'Automatic'.tr : 'Manual'.tr),
                      carType(image: Appcontent.petrol, title: 'Fuel type'.tr, subtitle: widget.carInfo!.carinfo.fuelType == '0' ? 'Petrol'.tr : widget.carInfo!.carinfo.fuelType == '1' ? 'Diesel'.tr : widget.carInfo!.carinfo.fuelType == '2' ? 'Electric'.tr : widget.carInfo!.carinfo.fuelType == '3' ? 'CNG'.tr : 'Petrol & CNG'.tr),
                      carType(image: Appcontent.seat, title: 'Seats'.tr, subtitle: '${widget.carInfo!.carinfo.totalSeat} ${'Seats'.tr}'.tr),
                    ],
                  ),
                ),
                SizedBox(height: 20),
    ...
    return Padding(
      ...
      child: SingleChildScrollView(
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text(widget.carInfo!.carinfo.carDesc, style: TextStyle(fontFamily: FontFamily.europaWoff, fontSize: 14, color: greyScale1,),),
            Container(
              ...
              child: Column(
                children: [
                  carTypeList(title: 'Car Number'.tr, brand: widget.carInfo!.carinfo.carNumber),
                  SizedBox(height: 15),
                  carTypeList(title: 'Total KM'.tr, brand: widget.carInfo!.carinfo.totalKm),
                  SizedBox(height: 15),
                  carTypeList(title: 'Car Brand'.tr, brand: widget.carInfo!.carinfo.carBrandTitle),
                  SizedBox(height: 15),
                  carTypeList(title: 'Car Type'.tr, brand: widget.carInfo!.carinfo.carTypeTitle),
                  SizedBox(height: 15),
                  carTypeList(title: 'Car AC'.tr, brand: widget.carInfo!.carinfo.carAc == '1' ? 'AC' : 'Non-AC'),
                ],
              ),
            ),
            Row(
            ...
            Row(
              ...
              children: [
                ...
                Expanded(child: Text(widget.carInfo!.carinfo.pickAddress, style: TextStyle(fontFamily: FontFamily.europaBold, color: notifire.getwhiteblackcolor, fontSize: 14))),
              ],
            ),
            Container(
              height: 200,
              ...
              child: ClipRRect(
                ...
                child: GoogleMap(
                  ...
                  initialCameraPosition: CameraPosition(target: LatLng(double.parse(widget.carInfo!.carinfo.pickLat), double.parse(widget.carInfo!.carinfo.pickLng)), zoom: 13),
          ...
          children: [
            ...
            Transform.translate(
              ...
              child: ListView.separated(
                ...
                itemCount: widget.carInfo!.carinfo.facilityImg.toString().split(",").length,
                        ...
                        children: [
                          Container(
                            height: 40,
                              ...
                              child: Image.network("${Config.imgUrl}${widget.carInfo!.carinfo.facilityImg.toString().split(",").elementAt(index)}"),
                          ),
                          SizedBox(width: 15),
                          Text(widget.carInfo!.carinfo.carFacility.toString().split(",").elementAt(index), style: TextStyle(fontFamily: FontFamily.europaBold, fontSize: 14, color: notifire.getwhiteblackcolor,),),
                          Spacer(),
    ...
    return Padding(
      ...
      child: SingleChildScrollView(
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            widget.carInfo!.galleryImages.isEmpty ? Padding(
              padding: const EdgeInsets.symmetric(vertical: 10),
              child: Column(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
